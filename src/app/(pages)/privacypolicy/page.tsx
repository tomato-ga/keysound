...
const PrivacyPolicy = () => {
	return (
		<div className="container mx-auto px-4 py-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第2条（個人情報の収集方法）</h2>
			<p className="text-lg mb-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第3条（個人情報を収集・利用する目的）</h2>
			<p className="text-lg mb-8">当サービスが個人情報を収集・利用する目的は、以下のとおりです。</p>
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第4条（利用目的の変更）</h2>
			<p className="text-lg mb-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第5条（個人情報の第三者提供）</h2>
			<p className="text-lg mb-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第6条（個人情報の開示）</h2>
			<p className="text-lg mb-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第7条（個人情報の訂正および削除）</h2>
			<p className="text-lg mb-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第8条（個人情報の利用停止等）</h2>
			<p className="text-lg mb-8">
			...
			<h2 className="text-2xl font-bold mt-10 mb-4">第9条（プライバシーポリシーの変更）</h2>
			<p className="text-lg mb-8">
				本ポリシーの内容は、法令その他本ポリシーに別段の定めのある事項を除いて、ユーザーに通知することなく、変更することができるものとします。
				当サービスが別途定める場合を除いて、変更後のプライバシーポリシーは、本ウェブサイトに掲載したときから効力を生じるものとします。
			</p>
			<h2 className="text-2xl font-bold mt-10 mb-4">第10条（お問い合わせ窓口）</h2>
			<p className="text-lg mb-8">本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。</p>
			<p className="text-lg mb-8">Eメールアドレス：katudon[[[@]]'']gmail.com　（無駄な記号を取り除いてください）</p>
		</div>
	)
}
