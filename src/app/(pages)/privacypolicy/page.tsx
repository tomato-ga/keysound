...
const Terms = () => {
	return (
		<div className="container mx-auto px-4 py-8">
			...
			<p className="text-lg mb-8">
				当サービスが個人情報を収集・利用する目的は、以下のとおりです。 当サービスサービスの提供・運営のため
			...
			<p className="text-lg mb-8">
				...
				当サービスの業務の適正な実施に著しい支障を及ぼすおそれがある場合 その他法令に違反することとなる場合
			...
			本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。 Eメールアドレス：
			oono[//[[@]]'']'hfm.tokyo　（無駄な記号を取り除いてください）
		</div>
	)
}
