				...
				{status === 'authenticated' && session ? (
					<div className="max-w-md mx-auto bg-gray-800 p-6 rounded-lg shadow-lg">
						<div className="flex items-center justify-center mb-6">
							...
							<div>
								<p className="text-xl font-semibold">ようこそ、{session.user?.name}さん</p>
								<p className="text-gray-400">セッションの期限：{session.expires}</p>
							</div>
						</div>
						{userExists && <p className="text-green-400 mb-4">ユーザーは既に存在します</p>}
